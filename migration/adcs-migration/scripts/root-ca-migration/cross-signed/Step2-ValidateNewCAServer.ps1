...
if ($allPassed) {
    ...
    Write-Host ""
    Write-Host "  NEXT: Run Step3-GenerateCSR.ps1 on this server" -ForegroundColor Yellow
    Write-Host "        to generate a CSR for cross-signing by the OLD Root CA." -ForegroundColor Yellow
    Write-Host ""
} else {
